...
int CommonData::indexCounter = 0;
int CommonData::nextMemoryCellAvailable = 0;
CommonData* CommonData::commonDataInstances[1024];

CommonData::CommonData() {

}

CommonData::CommonData(String name, String commandName, int valueLenght,
...
void CommonData::createCommonData(String name, String commandName, int valueLenght,
                                  String defaultValue, String valueType, void (setFunction)(String value)) {
  int counter = indexCounter;
  Logger::log("Creating new instance of CommonData: " + name, Logger::DEBUG_LOG);
...
void CommonData::getDataFromEeprom() {
  Logger::log("Getting data from EEPROM...", Logger::INFO_LOG);
